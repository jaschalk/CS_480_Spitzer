...
class CardRuleTree:
    ...
    def __init__(self):
        ...
        self._root = RuleNode("Returns true if the asking player is leading.", is_player_leading)
        __root_R = RuleNode("Returns true if the player has only one card", has_one_card)
        __root_RR = RuleNode("Returns true if any ace was called.", was_ace_called)
        __root_RRL = RuleNode("Returns true if the asking player has the called ace.", has_called_ace)
        __root_RRLL = RuleNode("Returns true if the card in questions is the called ace.", is_card_called_ace)
        __root_RRLLR = RuleNode("Returns true if the suit of the called ace was lead.", was_called_ace_suit_lead)
        __root_RRLLL = RuleNode("Returns true if the suit of the called ace was lead.", was_called_ace_suit_lead)
        __root_RRR = RuleNode("Returns true if the asking player has cards of the suit lead", has_suit_lead)
        __root_RRRL = RuleNode("Returns true if the card in question is of the suit lead", does_card_follow_suit)
        __root_RRRR = RuleNode("Returns true if the asking player has trump cards.", does_player_have_trump)
        __root_RRRRL = RuleNode("Returns true if the card in question is trump.", is_card_trump)
